...
### Structure of the Bootstrap Algorithm

::: {style="font-size:0.4em"}

Note: Bootstrap estimation follows the same computational cycle repeatedly
...
digraph flowchart {
  ...
  A [label = 'Observed TMB data']
  B [label = 'Resample with replacement']
  C [label = 'Compute estimator']
  D [label = 'Store estimate']
  E [label = 'Repeat many times']
  F [label = 'Bootstrap distribution']
...
Bootstrap distribution is then used to estimate:
